...
import { calcRentAmount, hasMonopolyGroup } from "../game/engine/rentUtils";
...
export function useGameEngine() {
  ...
  return {
    ...
    screen, setScreen, numPlayers, setNumPlayers, players, setPlayers,
    currentIdx, setCurrentIdx, phase, setPhase, dice, setDice, chaosDie, setChaosDie,
    propOwners, setPropOwners, propHouses, setPropHouses, log, jackpot, activeCard, setActiveCard,
    doubleRentTurns, pendingBuy, pendingRent, winner, animDice, ghostTarget,
    pendingGhostSteal, setPendingGhostSteal, playerNames, setPlayerNames,
    initialMoney, setInitialMoney, rentMultiplier, setRentMultiplier, chaosChance, setChaoschance,
    hasSavedGame, setHasSavedGame, showAdvancedSettings, setShowAdvancedSettings,
    turnTimer, setTurnTimer, showHelp, setShowHelp, showTutorial, setShowTutorial,
    features, squareInfo, rulesText,
    saveGame, loadGame, playSound, addLog,
    startGame, hasMonopoly, calcRent, doTransfer, nextTurn, landOnSquare, doRoll, applyChaosRoll, applyCardEffect,
    buyProperty, skipBuy, payRent, doEndTurn, buildHouse,
  };
}

export { SQUARE_DATA, GROUP_COLORS, PLAYER_CONFIGS, CHAOS_CARDS, getGridPos, getSquareRotation };
